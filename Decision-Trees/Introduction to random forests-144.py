...
auc = roc_auc_score(prediction, test["high_income"])
auc2 = roc_auc_score(prediction2, test["high_income"])
...
fin_predictions = numpy.round((predictions+predictions2)/2)
print(roc_auc_score(fin_predictions, test["high_income"]))
