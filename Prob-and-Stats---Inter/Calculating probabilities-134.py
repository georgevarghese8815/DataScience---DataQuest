...
days_over_threshold2 = bikes[bikes["cnt"] > 4000].shape[0]
probability_over_4000 = days_over_threshold2/total_days
...
prob_8 = counts(8,10) * probs(8,10)
prob_9 = counts(9,10) * probs(9,10)
prob_10 = counts(10,10) * probs(10,10)